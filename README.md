...
截至当前基线，完整验证结果为：API 169 个用例通过（另 1 个容器发布用例由真实栈测试执行），安全门禁 37/37、Web 单元测试 21/21、Desktop 单元测试 82/82、Web E2E 3/3、Desktop E2E 7/7、最终验收 24/24；`pnpm release:verify` 退出码为 0。
